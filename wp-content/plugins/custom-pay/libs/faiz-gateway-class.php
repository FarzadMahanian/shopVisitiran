...
class Aics_ipay_gateway extends WC_Payment_Gateway{
    ...
    public function preparePayment($order_id){
        $post_url = 'http://visitoiran.my:8000/ipg/api/v1/pay';
        ...
        <form id="ipaysubmitForm" action="<?php echo $post_url; ?>" method="POST">
            ...
            <input type="hidden" name="dataId" value="<?php echo $order_id; ?>">
            ...
            <input type="hidden" name="returnUrl" value="<?php echo $response_url; ?>">
        </form>
        <?php 
    }
